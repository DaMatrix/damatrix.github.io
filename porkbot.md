...
| Command name | Description                                                            | Usage                                          | Example                                                                | Note                                                          |
|--------------|------------------------------------------------------------------------|------------------------------------------------|------------------------------------------------------------------------|---------------------------------------------------------------|
| play         | Adds a song to the playlist.                                           | `..play <URL>` or `..play <search terms>`      | `..play a-ha take on me`                                               |                                                               |
...
| emojiid      | Gets the internal ID of an emoji                                       | `..emojiid <emoji>`                            | `..emojiid :ok_hand:`                                                  | In format of `<:emotename:snowflake>`                         |
| interject    | Sends the GNU/Linux copypasta                                          | `..interject`                                  | `..interject`                                                          |                                                               |
